...
<h2 class="section_title main">
        ...
        @method('POST')
            ...
            <div class="organization_section">
                <input type="text" name="title" class="request_main_input" placeholder="Заголовок">
                <input type="text" name="event_region" class="request_main_input" placeholder="Регион проведения мероприятия" required>
                <input type="text" name="event_locality" class="request_main_input" placeholder="Населнный пункт" required>
                <input type="text" name="event_date" class="request_main_input" placeholder="Дата" required>
                <input type="text" name="event_time" class="request_main_input" placeholder="Время" required>
